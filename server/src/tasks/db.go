...
// data func
func (db *Db) getTask(id int64) (tasks []DbTask, err error) {
...
func (db *Db) cols(id int64) (count int, col1, col2 string) {
...
func (db *Db) checkSQL(sql string) bool {
...
func (db *Db) compareSQL(baseSQL, userSQL string) bool {
...
func (db *Db) CheckTask(id int64, sql string) (results ResultList, err error) {
